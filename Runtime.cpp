...
short WINAPI DLLExport CreateRunObject(LPRDATA rdPtr, LPEDATA edPtr, fpcob cobPtr)
{
	...
	*/
	...
	rdPtr->SlowLoops = new map<string, SlowLoop>;
...
*/
	...
	if(rdPtr->SlowLoops != NULL) delete rdPtr->SlowLoops;
	rdPtr->SlowLoops = NULL;
...
*/
	...
	map<string, SlowLoop>::iterator it;
	for(it = rdPtr->SlowLoops->begin(); it != rdPtr->SlowLoops->end(); ++it)
	{
